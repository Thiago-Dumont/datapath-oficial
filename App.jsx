...
const Security = {
  ...
  generateJWT: (uid) => {
    ...
    const signature = btoa(uid + "dp_secret_key");
...
const DB = {
  g: (k) => {
    try {
      return JSON.parse(localStorage.getItem("dp_" + k) || "null");
    } catch {
      return null;
    }
  },
  ...
  s: (k, v) => {
    try {
      localStorage.setItem("dp_" + k, JSON.stringify(v));
    } catch {}
  },
...
// ======================================================
// COLE AQUI, SEM ALTERAR, TODO O SEU CÓDIGO ORIGINAL:
// - arrays dos 90 dias
// - componentes
// - contexto
// - hooks
...
// Se o nome do seu componente principal for DataPath,
// mantenha assim.
// Se for outro nome, troque apenas a chamada abaixo.
// ======================================================
...
// ======================================================
// COLE AQUI A SUA FUNÇÃO ORIGINAL DataPath
// Exemplo:
// function DataPath() {
//   return (
//     <div>...</div>
...
function DataPath() {
  return (
    <div>
      {/* SUBSTITUA ESTE BLOCO PELO SEU CONTEÚDO ORIGINAL */}
      <h1>DataPath ⚡</h1>
